...
<body class="text-monospace">
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<a class="navbar-brand" href="index.jsp"><i
			class="fa-solid fa-server"></i> Remote Server Managemnent &
			Management</a>
		...
		<div class="collapse navbar-collapse" id="navbarText">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active"><a class="nav-link" href="disks.jsp">Disks</a>
				</li>
	...
	<div class="vh-100">
		<div class="card mx-auto mt-5" style="height: 80%; width: 80%;">
			<h5 class="card-header">
				<i class="fa-solid fa-compact-disc"></i> Disks
			</h5>
			<div id="diskpage" class="card-body" style="overflow-y: auto"></div>
		</div>
	</div>
	<script
