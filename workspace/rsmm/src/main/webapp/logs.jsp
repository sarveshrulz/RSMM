	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="collapse navbar-collapse" id="navbarText">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active"><a class="nav-link" href="logs.jsp">Logs</a>
				</li>
	...
	<div class="vh-100">
		<div class="card mx-auto mt-5" style="height: 80%; width: 80%;">
			<h5 class="card-header">
				<i class="fa-solid fa-file-lines"></i> Dmesg
			</h5>
			<div id="logs" class="card-body" style="overflow-y: auto"></div>
		</div>
	</div>
	<script
