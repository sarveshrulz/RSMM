...
<body class="text-monospace">
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="collapse navbar-collapse" id="navbarText">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active"><a class="nav-link" href="report.jsp">Report</a></li>
			</ul>
	...
	<div class="vh-100">
		<div class="row px-5">
			<div class="col-sm-6 d-flex align-items-stretch" style="height: 50rem;">
				<div class="card mx-auto mt-5 w-100">
					<h5 class="card-header">
						<i class="fa-solid fa-terminal"></i> Commands
					</h5>
					<div id="commands" class="card-body" style="overflow-y: auto"></div>
				</div>
			</div>
			<div class="col-sm-6 d-flex align-items-stretch" style="height: 50rem;">
				<div class="card mx-auto mt-5 w-100">
					<h5 class="card-header">
						<i class="fa-solid fa-right-to-bracket"></i> Login time
					</h5>
					<div id="logintime" class="card-body" style="overflow-y: auto"></div>
				</div>
			</div>
		</div>
	</div>
